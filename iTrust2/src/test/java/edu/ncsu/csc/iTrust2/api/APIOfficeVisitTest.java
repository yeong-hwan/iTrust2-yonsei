...
import edu.ncsu.csc.iTrust2.services.EyecheckupService;
...
public class APIOfficeVisitTest {
        ...
        public void setup() {
                ...
                userService.saveAll(List.of(patient, hcp, od, oph, antti));
        ...
        /**
         * Tests eyecheckup API with OPH Role
         *
         * @throws Exception
         */
        @Test
        ...
        public void testOPHOfficeVisitAPI() throws Exception {
                ...
                assertTrue(v.getEyecheckup().getVisualAcuityOD().equals(20));
                assertTrue(v.getEyecheckup().getVisualAcuityOS().equals(20));
                assertTrue(v.getEyecheckup().getSphereOD().equals((float) -1.25));
                assertTrue(v.getEyecheckup().getSphereOS().equals((float) -1.5));
                assertTrue(v.getEyecheckup().getCylinderOD().equals((float) 0.5));
                assertTrue(v.getEyecheckup().getCylinderOS().equals((float) 0.75));
                assertTrue(v.getEyecheckup().getAxisOD().equals(90));
