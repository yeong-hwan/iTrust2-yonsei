...
public class APILabTestTest {
    ...
    public void order () throws Exception {
        ...
        Assert.assertEquals( "There should be one lab test in the system after creating a LabTest", 1, service.count() );
    ...
    public void unauthorizedOrder() throws Exception{
        ...
        Assert.assertEquals( "There should be no lab test in the system after creating a LabTest", 0, service.count() );
    }
    ...
    public void record_results() throws Exception{
        ...
        labtechMvc.perform( post( "/api/v1/lab_tests/record_results/" ).with(user("labtech").password("1234").roles("LABTECH"))
                .contentType(MediaType.APPLICATION_JSON)
        ...
        // view results
        labtechMvc.perform( get( "/api/v1/lab_tests/view_results/patient" ).with(user("labtech").password("1234").roles("LABTECH")))
                .andDo(MockMvcResultHandlers.print())
                .andExpect( status().isOk() );
    ...
    public void NoReultsFound() throws Exception{
        ...
        mvc.perform( MockMvcRequestBuilders.post( "/api/v1/users" ).contentType( MediaType.APPLICATION_JSON )
                .content( TestUtils.asJsonString( yewon ) ) ).andExpect( MockMvcResultMatchers.status().isOk() );
