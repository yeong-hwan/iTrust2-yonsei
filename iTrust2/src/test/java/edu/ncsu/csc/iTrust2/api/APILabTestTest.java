...
// Assert.assertEquals("There should be one lab test in the system after
// creating a LabTest", 1,
// service.count());
...
// Assert.assertEquals("There should be no lab test in the system after creating
// a LabTest", 0,
// service.count());
// }
...
// mvc.perform(MockMvcRequestBuilders.get("/api/v1/lab_tests/view_results/patient")
// .with(user("er").password("1234").roles("ER")))
// .andDo(MockMvcResultHandlers.print())
// .andExpect(status().isUnauthorized());
// }
